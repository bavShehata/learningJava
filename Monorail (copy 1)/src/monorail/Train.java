...
public class Train {
    protected Route = new Route();
    protected ArrayList<Integer> departure_time;
    protected ArrayList<Boolean> seats = new ArrayList<Boolean>();
    private static ArrayList<DepartureTime> departureTimes;

    public static ArrayList<DepartureTime> getDepartureTimes() {
    ...
    public void unreserveSeats(int numOfSeats){
        // Unreserve seats
    }
    // @Override
    public void display() {
